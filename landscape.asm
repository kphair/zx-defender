...
; original bitmap image for scanner
...
; scanner remapped to new screen height, probably won't be used as scanner height hasn't changed
...
; On the Speccy we should draw it at 73% (or 3/4) vertical to keep the same scale within the smaller playing area
; (160 pixels as opposed to the arcade version's 218). Most flexible way is to use a remapping table.
...
height_remap:   db  0, 1, 2, 3, 4, 5, 6, 7      ;  0 -  7
                ...
                db 30,31,32,33,34,35,36,37      ; 40 - 47
                db 36,37,38,39,40,41,42,43      ; 48 - 55
